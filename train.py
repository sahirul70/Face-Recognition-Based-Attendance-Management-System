...
window.configure(background='grey80')  # background='grey')
...
message = tk.Label(window, text="Face Recognition Based Attendance Management System", bg="black",
                   fg="white", width=50, height=3, font=('arial', 30, 'italic bold'))
...
txt = tk.Entry(window, width=25, bg="grey",
               fg="Black", font=('times', 15, ' bold '))
txt.place(x=600, y=210)

lbl2 = tk.Label(window, text="Student Name", width=20, fg="black",
                bg="grey", height=2, font=('times', 15, ' bold '))
lbl2.place(x=300, y=300)

txt2 = tk.Entry(window, width=25, bg="grey",
                fg="black", font=('times', 15, ' bold '))
...
message = tk.Label(window, text="", bg="grey80", fg="white", width=30,
                   height=2, activebackground="yellow", font=('times', 15, ' bold '))
message.place(x=600, y=400)

#lbl3 = tk.Label(window, text="Attendance : ", width=20, fg="black",
                #bg="grey", height=2, font=('times', 15, ' bold'))
#lbl3.place(x=300, y=600)


message2 = tk.Label(window, text="", fg="white", bg="grey80",
...
def TakeImages():
    ...
    if(is_number(Id) and name.isalpha()):
        ...
        row = [Id, name]
        with open('StudentsDetails\studentsDetails.csv', 'a+') as csvFile:
...
def TrackImages():
    ...
    df = pd.read_csv("StudentsDetails\StudentsDetails.csv")
    cam = cv2.VideoCapture(0)
...
takeImg = tk.Button(window, text="Take Images", command=TakeImages, fg="white", bg="SkyBlue1",
...
trackImg = tk.Button(window, text="Automatic Attendance", command=TrackImages, fg="white",
                     bg="SkyBlue1", width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
trackImg.place(x=700, y=500)
quitWindow = tk.Button(window, text="Quit", command=quit, fg="white", bg="SkyBlue1",
                       width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
